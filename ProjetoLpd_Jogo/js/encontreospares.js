...
const timer = document.querySelector('.timer');
        ...
        const checkEndGame = () => {
            ...
            if (cartasdesativasas.length == 10) {
                clearInterval(timerInterval);
                if (jogador1Pontos > jogador2Pontos) {
                    window.location.href = 'Vencedor1.html?resultado=Jogador1'; 
                
                } else if (jogador2Pontos > jogador1Pontos) {
                    window.location.href = 'vencedor2.html?resultado=Jogador2'; // Redireciona para a página com resultado de Jogador 2
                } else {
                    window.location.href = 'empate.html?resultado=Empate'; // Redireciona para a página com resultado de Empate
                }
            }
        }
